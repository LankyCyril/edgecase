...
\headerbox{Results}{name=giab_pb,span=1,column=1,below=hg38ext,boxColorOne=greenbox,headerColorOne=greenbox_adj,headerColorTwo=greenbox_adj}
{
    GIAB PB
    \vspace{2in}
}
...
\headerbox{}{name=no_flipflop,span=1,column=2,below=hg38ext,boxheaderheight=0mm,boxColorOne=greenbox}
{
    ONT no flipflop
    \vspace{2in}
}
...
\headerbox{}{name=flipflop,span=1,column=3,below=hg38ext,boxheaderheight=0mm,boxColorOne=greenbox}
{
    ONT flipflop
    \vspace{2in}
}
...
\headerbox{}{name=meme,span=1,column=1,below=giab_pb,above=bottom,boxheaderheight=0mm,boxColorOne=greenbox}
{
    MEME
...
\headerbox{Further work}{name=unimizers,span=1,column=2,below=giab_pb,above=bottom}
{
    Unimizers
}


\headerbox{}{name=unimizers,span=1,column=3,below=giab_pb,above=bottom,boxheaderheight=0mm}
{
    Assembly graph
}
