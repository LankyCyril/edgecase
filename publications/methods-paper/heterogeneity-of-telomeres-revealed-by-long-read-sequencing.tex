...
\textcolor{WCM}{??\% (?? of ??)} of these motifs, including the top \textcolor{WCM}{??} enriched on both arms, were confirmed in independently generated human linked-read, short-read genomic, and short-read transcriptomic datasets (\textcolor{WCM}{Supplementary Table X}).
