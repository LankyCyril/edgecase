...
22 out of 27 (81.5\%) of these motifs were confirmed in independently generated human short-read and linked-read genomic datasets (\hyperref[sec:supp_methods]{Supplementary methods}, \autoref{tab:shortread_repeatfinder}).
